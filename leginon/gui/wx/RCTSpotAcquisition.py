...
class ScrolledSettings(leginon.gui.wx.Acquisition.ScrolledSettings):
    def initialize(self):
        ...
        spots = addSpotSettings()

        return sizers + [sbsz, spots]

    def addSpotSettings(self):
        # spot size
        sb = wx.StaticBox(self, -1, 'Spot Scan Options')
        ...
        sbsz.Add(szspotsize, 0, wx.ALIGN_CENTER|wx.ALL, 2)
